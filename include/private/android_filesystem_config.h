...
#define AID_SENSORS       3009  /* access to /dev/socket/sensor_ctl_socket & QCCI/QCSI */
#define AID_READPROC      3010  /* Allow /proc read access */
#define AID_WAKELOCK      3011  /* Allow system wakelock read/write access */
